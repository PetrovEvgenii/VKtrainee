...
class ClockView @JvmOverloads constructor(
    ...
    private fun PointF.calculateXYForPoints(pos: Int, radius: Float) {
    ...
    private fun PointF.calculateXYForHourLabels(hour: Int, radius: Float) {
    ...
    private fun drawDots(canvas: Canvas) {
        ...
        for (i in 0 until 60) {
            position.calculateXYForPoints(i, dotsDrawLineRadius)
    ...
    private fun drawHourLabels(canvas: Canvas) {
        ...
        for (i in 1..12) {
            position.calculateXYForHourLabels(i, labelsDrawLineRadius)
    ...
    override fun onSaveInstanceState(): Parcelable {
        ...
        bundle.putInt("numbersColor", textColor)
    ...
    override fun onRestoreInstanceState(state: Parcelable?) {
        ...
        if (state is Bundle) {
            ...
            textColor = state.getInt("numbersColor")
